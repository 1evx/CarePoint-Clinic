...
public class Appointments {
    ...
    public String addNewAppointment(String id, String date, String time, String meridiem, String patientIcNumber, String specialization, String type) {
        ...
        String newAppointment = id + "," + date + "," + time + "," + meridiem + "," + patientIcNumber + "," + specialization + "," + type + "," + timeSlotId;
    ...
    public void deleteReservedAppointment (String deletedId, String deletedTimeSlotId) {
        AppointmentData queriedAppointment = queryAppointment(deletedId, null, null, null, null, null, null, null, null).getFirst();
        queriedAppointment.setStatus("cancelled");
        updateAppointment();
        TimeSlots timeSlots = new TimeSlots();
        TimeSlotData queriedTimeSlot = timeSlots.queryTimeSlot(deletedTimeSlotId, null, null, null, null, null, null, null).getFirst();
        queriedTimeSlot.setStatus("available");
