...
public class MedicalRecords {
    ...
    public String editMedicalRecord(String id, String description, String dose, String patientIcNumber) {
    ...
    public void updateMedicalRecord() {
        ...
        for (MedicalRecordData medicalRecord : medicalRecordList) {
            ...
            String description =  medicalRecord.getDescription().replace("\n", "\\n")
                    .replace("\r", "\\r")
                    .replace(",", "\\c");

            String dose = medicalRecord.getDose().replace("\n", "\\n")
                    .replace("\r", "\\r")
                    .replace(",", "\\c");
