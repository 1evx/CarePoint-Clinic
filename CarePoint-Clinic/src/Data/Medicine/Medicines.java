...
public class Medicines {
    ...
    public Boolean deleteMedicine(String deletedId) {
        List<PaymentData> paymentList = new Payments().getPaymentList();
        boolean deleteMedicineStatus = true;
        for (PaymentData payment : paymentList) {
            String[] paymentItem = payment.getItems();
            deleteMedicineStatus = Arrays.asList(paymentItem).contains(deletedId);
        }
