...
import File.File;
import Ui.DoctorUI.DoctorMainUI;
...
public class Doctors {
    ...
    public Object[] checkDoctorIc(String icNumber) {
        ...
        List<DoctorData> queriedDoctor = queryDoctor(null, null, icNumber, null, null, null, null, null);
        if (queriedDoctor.isEmpty()) {
            statusMessage[0] = "Doctor IC Number does not exist in the system.";
        }
        else {
            statusMessage[1] = queriedDoctor.getFirst();
        }
        return statusMessage;
    }
