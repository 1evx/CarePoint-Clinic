...
public class RoundedComponent extends JComponent {
    ...
    public RoundedComponent(int roundTopLeft, int roundTopRight, int roundBottomLeft, int roundBottomRight) {
        this.roundTopLeft = roundTopLeft;
        this.roundTopRight = roundTopRight;
        this.roundBottomLeft = roundBottomLeft;
        this.roundBottomRight = roundBottomRight;
        setOpaque(false); // Ensure the component is transparent to see the rounded shape
    }
